...
Since the SAM family works best when **each worker has its own gradient and weight puerturbation**, but in DataParallel mode in PyTorch the gradient is synchronized across workers.
